...
export const ENEMY_PRESETS = {
  ...
  berserker: {
    name: "Berserker",
    size: 28,
    color: [140, 20, 20] as [number, number, number],
    speed: 170,
    hp: 4,
    damage: 45,
  },
  berserker_elite: {
    name: "Berserker+",
    size: 32,
    color: [180, 10, 10] as [number, number, number],
    speed: 200,
    hp: 8,
    damage: 75,
  },
  shield_guard: {
    name: "Guarda do Escudo",
    size: 32,
    color: [110, 120, 130] as [number, number, number],
    speed: 70,
    hp: 12,
    damage: 30,
  },
  shield_guard_elite: {
    name: "Guarda do Escudo+",
    size: 38,
    color: [80, 90, 100] as [number, number, number],
    speed: 85,
    hp: 24,
    damage: 55,
  },
  ...
  phantom_elite: {
    name: "Fantasma+",
    size: 30,
    color: [126, 34, 206] as [number, number, number],
    speed: 125,
    hp: 12,
    damage: 65,
  },
  ...
  ninja_elite: {
    name: "Ninja+",
    size: 28,
    color: [15, 15, 15] as [number, number, number],
    speed: 240,
    hp: 10,
    damage: 55,
  },
  ...
  vampire: {
    name: "Vampiro",
    size: 28,
    color: [190, 24, 74] as [number, number, number],
    speed: 90,
    hp: 12,
    damage: 45,
  },
